            ...
            <tbody>
              {products.map((product, key) => (
                ...
                >
                  ...
                  >
                    <span
                      className={`productpageActiveInactive ${
                    ...
                    {visibleDropdownId === product.id && (
                      ...
                      >
                        ...
                        <a
                          ...
                          onClick={() =>
                            alert(
                              `Stock Adjustment action triggered for Product`,
                            )
                          }
                        >
                        ...
                        <a
                          ...
                          href="#"
                          onClick={() =>
                            alert(`Deactivate action triggered for Product`)
                          }
                        >
