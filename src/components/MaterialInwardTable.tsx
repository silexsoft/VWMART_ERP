...
interface MaterialInwardTableProps {
...
const MaterialInwardTable: React.FC<MaterialInwardTableProps> = ({
  MaterialInwards,
  totalProducts,
  currentPage,
  pagesize,
  ...
  const handleSelectAll = () => {
    if (selectedItems.length === MaterialInwards.length) {
          ...
          <table className="w-full table-auto border-collapse">
            <thead>
              <tr className="border-t border-stroke dark:border-strokedark">
                <th
                  ...
                  style={{ width: "10%" }}
                >
                  {MaterialInwards.length > 0 ? (
                    <input
                      type="checkbox"
                      onChange={handleSelectAll}
                      checked={selectedItems.length === MaterialInwards.length}
                    />
                  ) : (
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="po_qty border border-gray-300 text-right">
                  0.00
                </td>
                <td className="received_qty border border-gray-300 text-right">
                  0.00
                </td>
