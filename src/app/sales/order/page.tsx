...
export default function Page() {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Sales Order" links={[{ label: "", route: "/" }]} />

      <div className="product_page expense_page allpages-box-header">
        <div className="total_expanse d-flex mb-3 mt-3 flex-wrap justify-center gap-10">
          <div className="status_container d-flex flex-column align-items-center gap-3">
      ...
      <div className="common_page_layout salesorder-new-page">
          ...
          <div className="m-portlet__head m-portlet__head__sm d-flex align-items-center justify-content-between mb-4">
            <div className="d-flex align-items-center ml-auto gap-2">
              ...
              <button
                ...
                onClick={() => router.push("/sales/order/new")}
              >
                Create New
              </button>
            </div>
