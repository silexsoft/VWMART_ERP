...
export default function Page() {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Credit Note" links={[{ label: "", route: "/" }]} />

      <div className="product_page creditnote_page allpages-box-header">
      ...
      <div className="common_page_layout creditnote-new-page">
          ...
          <div className="m-portlet__head m-portlet__head__sm d-flex align-items-center justify-content-between mb-4">
            <div className="d-flex align-items-center ml-auto gap-2">
              ...
              <button
                ...
                onClick={() => router.push("/sales/creditnote/new")}
              >
                Create New
              </button>
            </div>
