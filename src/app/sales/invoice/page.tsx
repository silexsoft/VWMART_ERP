...
export default function Page() {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Invoice" links={[{ label: "", route: "/" }]} />
      <div className="product_page expense_page allpages-box-header">
        <div className="total_expanse d-flex mb-3 mt-3 flex-wrap justify-center gap-5">
          ...
          <div className="status_container d-flex flex-column align-items-center flex-wrap gap-3">
            <span className="w-30 rounded border fill-current p-3 text-center">
              0
            </span>
