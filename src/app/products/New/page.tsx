...
const ProductDetailNew = () => {
  ...
  const [product, setProduct] = useState<any>({
    ...
    pre_order_availability_start_date_time_utc: "2025-01-15T09:24:35.04Z",
    call_for_price: true,
    price: Number,
    old_price: Number,
    product_cost: Number,
    ...
    mark_as_new: true,
    mark_as_new_start_date_time_utc: "2025-01-15T09:24:35.04Z",
    mark_as_new_end_date_time_utc: "2025-01-15T09:24:35.04Z",
    ...
    width: Number,
    height: Number,
    available_start_date_time_utc: new Date(),
    available_end_date_time_utc: new Date(),
    display_order: Number,
    published: true,
    deleted: false,
    created_on_utc: new Date(),
    updated_on_utc: new Date(),
    image_url: "",
    category_names: "",
    manufacturer_names: "",
    id: 0,
  ...
  const handleUpdate = async () => {
    try {
      ...
      if (selectedcategory.length !== 0) {
        const categoryResonse = await updateProductCategory(
          selectedcategory,
          response.id,
        );
      }
      ...
      if (selectedbrand.length !== 0) {
        const manufacturerResponse = await updateProductManufacturer(
          selectedbrand,
          response.id,
        );
      }
  ...
  const updateProductManufacturer = async (
    selectedbrand: any,
    projectId: any,
  ) => {
    try {
  ...
  const CreateProduct = async (productData: any) => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_HOST}/api-backend/Product/Create`,
        {
          method: "POST",
          headers: {
    ...
    <DefaultLayout>
      ...
      <div className="product-detail-page common_page_layout">
        <div className="productdetailpage">
          ...
          <h3 className="header-font">New Product</h3>
                      ...
                      <div className="col-lg-12 col-md-12 col-sm-12">
                        <div className="input-group">
                          ...
                          >
                            ...
                            <option value="65605" data-rate="18.0">
                              GST 18(18.0%)
                            </option>
