...
const MaterialCreationNew = () => {
  ...
  const [isTextboxVisibleSecond, setTextboxVisibleSecond] = useState(false);
  const handleArrowClick = (event: any) => {
    setTextboxVisible(!isTextboxVisible);
  };

  const handleArrowClickSecond = (event: any) => {
    setTextboxVisibleSecond(!isTextboxVisibleSecond);
  };

  // const [MaterialCreations, setMaterialCreations] = useState<any[]>([]); // Initialize as an array
  ...
  const [MaterialTaken, SetMaterialTaken] = useState<any>({
    Id: "",
    Sku: "",
    ProductName: "",
    BatchNo: "",
  ...
  const [MaterialRecieved, setMaterialRecieved] = useState<any>({
    Id: "",
    Sku: "",
    ProductName: "",
    BatchNo: "",
  ...
  const [searchQuerySecond, setSearchQuerySecond] = useState<string>("");
  ...
  const handleSelectChangeSecond = (
    e: React.ChangeEvent<HTMLSelectElement>,
  ) => {
    setSelectedValueSecond(e.target.value);
    fetchProductForMaterailTaken(e.target.value);
  };
  ...
  const handleInputChange = (
    ...
    SetMaterialTaken((prevProduct: any) => ({
  ...
  const handleInputChangeSecond = (
    ...
    const { name, value } = e.target;
    setMaterialRecieved((prevProduct: any) => ({
      ...prevProduct, // Spread the previous state
      [name]: value, // Update the specific field
    }));
  };
  ...
  const handleSearchChangeSecond = (
    event: React.ChangeEvent<HTMLInputElement>,
  ) => {
    const query = event.target.value; // Capture the search input value
    setSearchQuerySecond(query); // Update the searchQuery state
    fetchProducts(query); // Fetch categories with the updated search query and reset to page 0
  };
  ...
  const fetchProduct = async (query: string) => {
    try {
      ...
      // Map the data for dropdown if needed
      //   SetMaterialTaken(
      //    data && data.length > 0
      ...
      //     Description: '',
      //     QtyTaken: '',
      //     MrpTaken: product.price || '',
      //     UnitCostTaken: product.price || '',
      //     LandingPriceTaken: product.price || '',
      //     SalesRateTaken: product.price || '',
      //     TaxRateTaken: 0,
      //     TotalTaken: 0,
      //     QtyReceived: '',
      //     MrpReceived: '',
      ...
      if (data && data.length > 0) {
        SetMaterialTaken({
          ...
          BatchNo: "",
          QtyTaken: "",
          MrpTaken: data[0]?.price || "",
          UnitCostTaken: data[0]?.price || "",
          LandingPriceTaken: data[0]?.price || "",
          SalesRateTaken: data[0]?.price || "",
          TaxRateTaken: "",
          TotalTaken: "",
        });
      }
  ...
  const fetchProductForMaterailTaken = async (query: string) => {
    try {
      console.log("Search query for single product:", query);
      const url = `${process.env.NEXT_PUBLIC_API_HOST}/api-backend/Product/GetProductsByIds/${query}`;
      const response = await fetch(url, {
      ...
      // setMaterialCreationProductName(data[0].name || '');
      ...
      //     BatchNo: '',
      //     QtyReceived: '',
      //     MrpReceived: product.price || '',
      //     UnitCostReceived: product.price || '',
      //     LandingPriceReceived: product.price || '',
      //     SalesRateReceived: product.price || '',
      //     TaxRateReceived: '',
      //     TotalReceived: '',
      //   }))
      // : []
      ...
      if (data && data.length > 0) {
        setMaterialRecieved({
          ...
          BatchNo: "",
          QtyReceived: "",
          MrpReceived: data[0]?.price || "",
          UnitCostReceived: data[0]?.price || "",
          LandingPriceReceived: data[0]?.price || "",
          SalesRateReceived: data[0]?.price || "",
          TaxRateReceived: "",
          TotalReceived: "",
        });
      }
  ...
  useEffect(() => {
    console.log("MaterialTaken" + JSON.stringify(MaterialTaken));
  }, [MaterialTaken]);
  ...
  const InsertMaterialCreation = async (
    materialcreation: any,
    materialtaken: any,
    materialrecieved: any,
  ) => {
    try {
      console.log("materialcreation" + JSON.stringify(materialcreation));
      console.log("materialtaken" + JSON.stringify(materialtaken));
      console.log("materialrecieved" + JSON.stringify(materialrecieved));

      materialcreation.Id = 0;
      materialcreation.Sku = materialtaken.Sku;
      materialcreation.ProductName = materialtaken.ProductName;
      materialcreation.BatchNo = materialtaken.BatchNo;
      materialcreation.MaterialCreationNo = materialtaken.MaterialCreationNo;
      materialcreation.Description = materialtaken.Description;
      materialcreation.QtyTaken = Number(materialtaken.QtyTaken);
      materialcreation.MrpTaken = materialtaken.MrpTaken;
      materialcreation.UnitCostTaken = materialtaken.UnitCostTaken;
      materialcreation.LandingPriceTaken = materialtaken.LandingPriceTaken;
      materialcreation.SalesRateTaken = materialtaken.SalesRateTaken;
      materialcreation.TaxRateTaken = materialtaken.TaxRateTaken;
      materialcreation.TotalTaken =
        Number(materialtaken.QtyTaken) * materialtaken.UnitCostTaken || 0;
      materialcreation.QtyReceived = Number(materialrecieved.QtyReceived);
      materialcreation.MrpReceived = materialrecieved.MrpReceived;
      materialcreation.UnitCostReceived = materialrecieved.UnitCostReceived;
      materialcreation.LandingPriceReceived =
        materialrecieved.LandingPriceReceived;
      materialcreation.SalesRateReceived = materialrecieved.SalesRateReceived;
      materialcreation.TaxRateReceived = materialrecieved.TaxRateReceived;
      materialcreation.TotalReceived =
        Number(materialrecieved.QtyReceived) *
          materialrecieved.UnitCostReceived || 0;
      materialcreation.Created_at = new Date();
      materialcreation.Updated_at = new Date();
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_HOST}/api-backend/Product/InsertMaterialCreationDetails`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      handleOpenModal();
      const data = await response.json();
      console.log("inserted data material creation" + data);
      return data;
    } catch (error) {
    } finally {
    }
  ...
  const handleUpdate = async () => {
    try {
      const response = await InsertMaterialCreation(
        MaterialCreations,
        MaterialTaken,
        MaterialRecieved,
      );
  ...
  return (
    <DefaultLayout>
      <Breadcrumb
        pageName="New Material creation"
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-lg-6 col-6">
                          <input
                            ...
                            id="MaterialCreationNo"
                            value={MaterialTaken?.MaterialCreationNo || ""}
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-lg-12 col-12">
                          <textarea
                            ...
                            value={MaterialTaken?.Description || ""}
                            readOnly
                          ></textarea>
                        </div>
                      </div>
                        ...
                        <tr data-raw-item="template" className="m--hide">
                          ...
                          <td style={{ width: "150px" }}>
                            <input
                              ...
                              value={MaterialTaken?.ProductName || ""}
                              onChange={handleInputChange}
                            />
                            <span
                              id="dropdown"
                          ...
                          <td style={{ width: "150px" }}>
                            <input
                              ...
                              name="QtyTaken"
                              id="QtyTaken"
                              value={MaterialTaken?.QtyTaken || ""}
                              onChange={handleInputChange}
                            />
                          </td>

                          <td style={{ width: "150px" }}>
                            <label>{MaterialTaken?.MrpTaken || ""}</label>
                          </td>

                          <td style={{ width: "150px" }}>
                            <label>{MaterialTaken?.UnitCostTaken || ""}</label>
                          </td>

                          <td style={{ width: "150px" }}>
                            <label>
                              {MaterialTaken?.LandingPriceTaken || ""}
                            </label>
                          </td>

                          <td style={{ width: "150px" }}>
                            <label>{MaterialTaken?.SalesRateTaken || ""}</label>
                          </td>

                          <td style={{ width: "150px" }}>
                            <label>{MaterialTaken?.TaxRateTaken || ""}</label>
                          </td>

                          <td style={{ width: "150px" }}>
                            <label>{MaterialTaken?.TotalTaken || ""}</label>
                          </td>
                        </tr>
                      </tbody>
                      <tfoot>
                        <tr>
                          <th colSpan={11} className="text-center">
                            ...
                            <span id="totalAmountRaw">
                              {MaterialTaken?.QtyTaken *
                                MaterialTaken?.UnitCostTaken || 0}
                            </span>
                          </th>
                        </tr>
                      </tfoot>
                        ...
                        <tr data-raw-item="template" className="m--hide">
                          ...
                          <td style={{ width: "150px" }}>
                            <input
                              ...
                              name="ProductName"
                              id="ProductName"
                              value={MaterialRecieved?.ProductName || ""}
                              onChange={handleInputChangeSecond}
                            />
                            ...
                            <span
                              id="dropdown"
                              className="form-control"
                              onClick={handleArrowClickSecond}
                            >
                              {" "}
                              ^
                            </span>
                            {isTextboxVisibleSecond && (
                              <div style={{ marginTop: "10px" }}>
                                <input
                                  type="text"
                                  id="textboxSecond"
                                  ...
                                  onChange={handleSearchChangeSecond}
                                />
                                <select
                          ...
                          <td style={{ width: "150px" }}>
                            <input
                              ...
                              name="BatchNo"
                              id="BatchNo"
                              value={MaterialRecieved?.BatchNo || ""}
                              onChange={handleInputChangeSecond}
                            />
                          </td>
                          ...
                          <td style={{ width: "150px" }}>
                            <input
                              ...
                              name="QtyReceived"
                              id="QtyReceived"
                              value={MaterialRecieved?.QtyReceived || ""}
                              onChange={handleInputChangeSecond}
                            />
                          </td>
                          ...
                          <td style={{ width: "150px" }}>
                            <input
                              ...
                              name="MrpReceived"
                              id="MrpReceived"
                              value={MaterialRecieved?.MrpReceived || ""}
                              onChange={handleInputChangeSecond}
                            />
                          </td>
                          ...
                          <td style={{ width: "150px" }}>
                            <input
                              ...
                              id="UnitCostReceived"
                              value={MaterialRecieved?.UnitCostReceived || ""}
                              onChange={handleInputChangeSecond}
                            />
                          </td>
                          ...
                          <td style={{ width: "150px" }}>
                            <input
                              ...
                              value={MaterialRecieved?.SalesRateReceived || ""}
                              onChange={handleInputChangeSecond}
                            />
                          </td>

                          <td style={{ width: "150px" }}>
                            <label>{MaterialRecieved?.TaxRateReceived}</label>
                          </td>

                          <td style={{ width: "150px" }}>
                            <label>{MaterialRecieved?.TotalReceived}</label>
                          </td>
                        </tr>
                      </tbody>
                    </table>
...
export default MaterialCreationNew;
