...
export default function Page() {
  ...
  const columns = [
    ...
    { label: "Paid Amount", type: "input", name: "description" },
    { label: "Pending Amount", type: "input", name: "amount" },
    { label: "Kasar Amount", type: "input", name: "discount", required: true },
    {
      label: "Amount",
      type: "select",
      name: "tax",
    ...
    { label: "Payment Amount", type: "input", name: "tax_value" },
  ];
  ...
  return (
    <DefaultLayout>
      <Breadcrumb
        pageName="New Payment"
        links={[{ label: "Payment", route: "/Bank/payment" }]}
      />
      <div className="common_page_layout bankpayment-new-page">
        <div className="m-content new_payment">
          <form
