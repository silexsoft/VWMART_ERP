...
export default function Page() {
  ...
  const columns = [
    ...
    { label: "Net Amount", type: "input", name: "description" },
    { label: "Paid Amount", type: "input", name: "amount" },
    { label: "Pending Amount", type: "input", name: "discount" },
    {
      label: "Kasar Amount",
      type: "select",
      name: "tax",
    ...
    { label: "Amount", type: "input", name: "tax_value" },
    {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb
        pageName="New Bank Receipt"
        links={[{ label: "Bank Receipt", route: "/Bank/receipt" }]}
      />
      <div className="common_page_layout bankreceipt-new-page">
        <div className="m-content new_receitp create_new">
          <form
