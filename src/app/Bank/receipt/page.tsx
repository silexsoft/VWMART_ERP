...
const Payments = () => {
  ...
  const ActionsCell = ({ row }: any) => {
    ...
    const handleDelete = () => {
      alert("Inside delete. Id is " + row.id);
    };
        ...
        {action && (
          ...
          >
            <span
              ...
              onClick={() => router.push(`/Bank/receipt/${row.id}/edit`)}
            >
      ...
      renderCell: (value: any, row: any) => {
        return (
          <span
            ...
            onClick={() => {
              router.push(`/Bank/receipt/${row.id}`);
            }}
          >
            {value}
          </span>
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Receipt" links={[{ label: "", route: "/" }]} />
      <div className="common_page_layout bankreceipt-new-page">
        <div className="product_page">
          <div className="product_page receipt_page">
            <div className="m-portlet__head m-portlet__head__sm d-flex align-items-center justify-content-between mb-4">
              <div className="d-flex align-items-center ml-auto gap-2">
                ...
                <button
                  ...
                  onClick={() => router.push("/Bank/receipt/new")}
                >
                  Create New
                </button>
              </div>
